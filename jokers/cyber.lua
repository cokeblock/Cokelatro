SMODS.Joker{ --cybernetic69
    ...
    loc_txt = {
        ['name'] = 'cybernetic69',
        ['text'] = {
            [1] = '{C:dark_edition}^10{} Mult. {C:green}1 in 30 chance{} to remove all {C:money}money{},',
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_e7790761', 1, card.ability.extra.odds, 'j_cokelatr_cyber') then
