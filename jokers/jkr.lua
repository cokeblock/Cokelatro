SMODS.Joker{ --JKR//1011101
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_23d2697b', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
                ...
                if SMODS.pseudorandom_probability(card, 'group_1_2a194631', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
                ...
                if SMODS.pseudorandom_probability(card, 'group_2_0c497f05', 1, card.ability.extra.odds2, 'j_cokelatr_jkr') then
                ...
                if SMODS.pseudorandom_probability(card, 'group_3_62165083', 1, card.ability.extra.odds3, 'j_cokelatr_jkr') then
                ...
                if SMODS.pseudorandom_probability(card, 'group_4_0906cd88', 1, card.ability.extra.odds4, 'j_cokelatr_jkr') then
                ...
                if SMODS.pseudorandom_probability(card, 'group_5_355e477b', 1, card.ability.extra.odds4, 'j_cokelatr_jkr') then
                      card.ability.extra_value = (card.ability.extra_value or 0) + card.ability.extra.sell_value
            card:set_cost()
                        card_eval_status_text(context.blueprint_card or card, 'extra', nil, nil, nil, {message = "G10011G-1110011EE10NR", colour = G.C.MONEY})
                  end
            end
        end
        if context.setting_blind  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_a4c6fee1', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
        ...
        ease_hands_played(card.ability.extra.hands)
                ...
                if SMODS.pseudorandom_probability(card, 'group_1_6c0dd9d2', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
                      SMODS.calculate_effect({func = function()
        ...
        ease_hands_played(card.ability.extra.hands2 - G.GAME.current_round.hands_left)
                ...
                if SMODS.pseudorandom_probability(card, 'group_2_1ad9d47d', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
                      SMODS.calculate_effect({func = function()
        ...
        ease_discard(card.ability.extra.discards)
                ...
                if SMODS.pseudorandom_probability(card, 'group_3_68a0e6d6', 1, card.ability.extra.odds, 'j_cokelatr_jkr') then
                      SMODS.calculate_effect({func = function()
                card_eval_status_text(context.blueprint_card or card, 'extra', nil, nil, nil, {message = "CDE:DSCRD-1", colour = G.C.RED})
                
        G.GAME.round_resets.discards = G.GAME.round_resets.discards - card.ability.extra.discards2
        ease_discard(-card.ability.extra.discards2)
        
                return true
            end}, card)
                  end
                if SMODS.pseudorandom_probability(card, 'group_4_315485dc', 1, card.ability.extra.odds2, 'j_cokelatr_jkr') then
                      SMODS.calculate_effect({func = function()
                ...
                if SMODS.pseudorandom_probability(card, 'group_5_2c0af43e', 1, card.ability.extra.odds2, 'j_cokelatr_jkr') then
                      SMODS.calculate_effect({func = function()
                local current_hand_size = G.hand.config.card_limit
