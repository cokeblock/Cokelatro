SMODS.Joker{ --J.O.K.E.R
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [2] = '{C:green}#3# in #2# chance{} a held',
    ...
    loc_vars = function(self, info_queue, card)
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds, 'group_0_076d5d43') --Please-work
    ...
    calculate = function(self, card, context)
        if context.using_consumeable and not context.blueprint then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_076d5d43', 1, card.ability.extra.odds, 'group_0_076d5d43') then
