SMODS.Joker{ --ANYTHING AND EVERYTHING
    ...
    loc_vars = function(self, info_queue, card)
        return {vars = {card.ability.extra.Allowedjokers, card.ability.extra.j_joker, card.ability.extra.var1, (#(G.jokers and (G.jokers and G.jokers.cards or {}) or {})) * 2}}
    end,

    calculate = function(self, card, context)
        if context.buying_card and not context.blueprint then
            if (#G.jokers.cards > card.ability.extra.Allowedjokers and not (context.card and (context.card.ability.set == 'Tarot' or context.card.ability.set == 'Planet' or context.card.ability.set == 'Spectral'))) then
                return {
        ...
        if context.cardarea == G.jokers and context.joker_main then
                return {
                    Xmult = (#(G.jokers and G.jokers.cards or {})) * 2
                }
        end
    end
}