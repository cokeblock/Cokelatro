...
SMODS.Joker{ --Hiding Graphs
    ...
    calculate = function(self, card, context)
        if context.repetition and context.cardarea == G.play then
            if (card.ability.extra.JOKE or 0) == 1 then
                return {
        ...
        if context.individual and context.cardarea == G.play and not context.blueprint then
            ...
            elseif (card.ability.extra.JOKE or 0) == 1 then
                card.ability.extra.JOKE = 0
            end
        end
...
SMODS.Joker{ --Pale Joker
    ...
    calculate = function(self, card, context)
        if context.end_of_round and context.game_over and context.main_eval and not context.blueprint then
                ...
                return true
                    ...
                    extra = {
                        ...
                        extra = {
                            func = function()
                    card.ability.extra.vara = (card.ability.extra.vara) + 1
                    return true
                end,
                            colour = G.C.GREEN
                        }
        ...
        if context.ending_shop and not context.blueprint then
            if (card.ability.extra.vara or 0) == 1 then
                return {
                    func = function()
