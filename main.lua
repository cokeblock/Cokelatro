...
SMODS.Joker{ --Crypto Scam
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [2] = 'if {C:money}money{} is between {X:money,C:white}0{} Multiply payout by {X:red,C:white}X2{}',
...
SMODS.Joker{ --Cokeblock4043
    ...
    loc_txt = {
        ['name'] = 'Cokeblock4043',
        ['text'] = {
            [1] = 'Gains {X:red,C:white}X4.043{} Mult if played hand',
    ...
    return rankCount >= 1
                ...
                card.ability.extra.blocmult = (card.ability.extra.blocmult) + 4.043
                return {
                    message = "NOPE!",
                    extra = {
